...
## Project Structure
    ...
    ├── hugo_sample_project_87899  # Django project configurations
...
1. Clone this repo and `cd hugo_sample_project_87899`
...
2. Clone this repo and `cd hugo_sample_project_87899`
